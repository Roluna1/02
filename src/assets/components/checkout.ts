...
import { products, FormatProduct, loadProducts } from "../data/products";
...
loadProducts(renderSummany);

function renderSummany() {
    ...
    if (gettingProduct) {
      ...
      <div class="checkout-content checkout-content-${gettingProduct.id}">
        <div class="checkout-img-container">
          <img class="checkout-img" src="./src/assets/img/${gettingProduct.img}">
        </div>
